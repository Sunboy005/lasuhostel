...
$program=$_POST['program'];
 ...
 $sql="INSERT INTO userreg (hid,fname,oname,lname,sex,phone,email,password,program) 
...
<head>
	...
	<title>Student Registration :: Lagos State University Hostels</title>
...
<div class="col-sm-4">
<center><b><input type="text" value="<?php echo "$D"; ?>" class="form-control" disabled></b></center>
</div>
<label class="col-sm-6 control-label"> The Hostel ID will be used when Login in your account, Write it down!!!</label>
</div>
...
<div class="col-sm-4">
<input type="text" name="oname" id="oname"  class="form-control" required="required" >
</div>
</div>
...
<option value="Undergrauate">Undergrauate</option>
<option value="Extra Year">Extra Year</option>
<option value="Post Graduates">Post Graduade</option>
<option value="Master Students">Masters Student</option>
</select>
</div>
</div>
...
<input type="submit" name="submit" Value="Register" class="btn btn-primary"  required="required">
</div>
</form>
